...
The instructions for this workspace live in **[AGENTS.md](AGENTS.md)** — one
file, so every agent (Claude Code, Codex, Cursor) reads the same thing. Read it
before doing anything in here.
...
which ones you can start right now.**
